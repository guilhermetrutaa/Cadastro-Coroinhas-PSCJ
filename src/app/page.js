      ...
      <div>
        <div className='w-full min-h-screen bg-[#f9f9f9]' style={{ fontFamily: 'Montserrat, sans-serif' }}>
          ...
          <div className='pb-10'>
            ...
            <div className='flex justify-center items-center'>
              <button className='px-[3.6rem] py-2 rounded-[10px] bg-[#f9f9f9] border-2 border-[#000] text-[#000] cursor-pointer' onClick={() => router.push('/cadastros/cadastroVelho')}>Já sou velho</button>
            </div>
